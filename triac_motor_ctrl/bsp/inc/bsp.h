...
#define AC_LINE_FREQ_50_HZ          50
#define AC_LINE_FREQ_60_HZ          60
 ...
 * TIM1 for buzzer
 */
#define BUZZER_TIM_INSTANCE         TIM1
#define BUZZER_TIM_CHANNEL          TIM_CHANNEL_4
#define BUZZER_FREQUENCY            4000     // 4kHz
#define BUZZER_DUTY_CYCLE           50       // 50%
#define BUZZER_PIN                  TIM1_CH4
#define BUZZER_PIN_AF               GPIO_AF13_TIM1
